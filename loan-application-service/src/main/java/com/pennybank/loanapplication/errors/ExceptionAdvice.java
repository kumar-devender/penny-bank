...
public class ExceptionAdvice {
    ...
    @ResponseStatus(value = CONFLICT)
    public ValidationErrorDTO handleRequestValidationErrors(ConstraintViolationException e) {
        log.debug("Encountered validation exception while processing request, responding with [{}]", CONFLICT, e);
        return new ValidationErrorDTO().addGlobalError("Encountered constraint validation exception while processing request");
    }
